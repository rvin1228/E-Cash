...
namespace ECash
{
    ...
    class Program
    {
        static void Main(string[] args)
        {
            ...
            /*
             [FIX ISSUES]
             Multiple Accounts (array in class)
             Processing Fee (create object for fee)
             Fix Negative Balance (if else to > 0)
             Typo from Printscreens
            */

            user1.info("Sample Name", "January 1, 2000", 09123456789, 1111, "Filipino", "sample@gmail.com", "Philippines");
